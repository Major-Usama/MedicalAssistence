...
export default function DonorLocationScreen() {
    return (
        <SafeAreaView style={styles.container}>
        <StatusBar
        barStyle="white-content"
        hidden={false}
        backgroundColor="#C44400"
      />
         <View></View>
        ...
        <Image resizeMode='contain'  style={{width:wp('100%'),flex:1,marginBottom:50}} source={require('../images/donarmap.png')}/>
        ...
        <View style={{...styles.header,position:'absolute',bottom:0,paddingHorizontal:wp(0)}}>
          <View style={styles.leftSideContainer}>
            ...
            <Text style={{...styles.aboutUS,fontSize:22}}>Nearby Hospital</Text>
          </View>
