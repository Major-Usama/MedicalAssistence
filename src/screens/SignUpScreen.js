...
import { ImageBackground, SafeAreaView, StyleSheet, TextInput,Text, View, } from 'react-native'
...
const [phone, setPhone] = React.useState("");
    ...
    return (
        ...
        style={{alignSelf:'flex-start',marginLeft:wp('4%'),paddingTop:hp('3%')}} name="arrowleft" size={26} color="#ffffff" />
      ...
      />
       ...
       <Entypo name="phone" size={24} color="lightgray" />
        ...
        <View style={{alignSelf:'center',marginTop:hp('4%')}}>
            <Text style={{color:'#fff'}}>Already have an account? <Text onPress={()=>navigation.navigate('LoginScreen')} 
            
            style={{color:'#26C975',textDecorationLine:'underline'}}>Log in</Text></Text>
        </View>
